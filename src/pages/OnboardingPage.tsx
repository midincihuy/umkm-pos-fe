      ...
      <div className="min-h-screen flex flex-col items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-lg shadow-md p-8">
          <h1 className="text-2xl font-bold text-gray-900 mb-4">
            Selamat datang di Dompet Keluargaku!
          </h1>
          <p className="text-gray-600 mb-6 font-small">
            Anda sudah memiliki spreadsheet dengan ID {spreadsheetId} <a href={`https://docs.google.com/spreadsheets/d/${spreadsheetId}`} target="_blank" className="w-full bg-white-600 hover:bg-blue-700 hover:text-white">Klik untuk melihat Sheet</a>
          </p>
          <button
            onClick={() => navigate('/dashboard')}
            className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded mb-3"
          >
            Masuk ke Dashboard
          </button>
          <button
          ...
          >
            {loading ? 'Memproses...' : 'Remove Spreadsheet ID'}
          </button>
        </div>
      </div>
    )
